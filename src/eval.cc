...
alignas(64) static constexpr int16_t PST[6][64] = {
    ...
    // 3: white rook
    {0, 0,  0, 5,  5,  0,  0,  0,  -5, 0, 0, 0, 0,  0,  0, -5, -5, 0, 0,
     0, 0,  0, 0,  -5, -5, 0,  0,  0,  0, 0, 0, -5, -5, 0, 0,  0,  0, 0,
    ...
    // 5: white king (middlegame)
    {20,  30,  10,  0,   0,   10,  30,  20,  20,  20,  0,   0,   0,   0,   20,  20,  -10, -20, -20,
     -20, -20, -20, -20, -10, -20, -30, -30, -40, -40, -30, -30, -20, -30, -40, -40, -50, -50, -40,
